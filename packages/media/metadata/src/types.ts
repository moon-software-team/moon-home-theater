 ...
 * @example '--show_program_version' or '--show_versions' for the program version
 * @example '--show_library_versions' or '--show_versions' for the library versions
 */
export interface FFProbeResult {
  streams?: FFProbeStream[] | undefined;
  format?: FFProbeFormat | undefined;
  chapters?: FFProbeChapter[] | undefined;
  program_version?: FFProbeProgramVersion | undefined;
  library_versions: FFProbeLibraryVersion[] | undefined;
}

/** Options for the getMediaMetadata */
export interface FFProbeOptions {
  showStreams?: boolean;
  showFormat?: boolean;
  showChapters?: boolean;
  showVersions?: boolean;
  showLibraryVersions?: boolean;
